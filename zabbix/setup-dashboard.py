...
def main():
    ...
    widgets = [
        ...
        item_widget(
            ...
            18,
            23,
            itemid("artpgr01p", "net.tcp.service[http,,9090]"),
            "Prometheus HTTP",
            "ART14",
        ),
        item_widget(
        ...
        graph_widget(
            ...
            [
                ...
                {"host": "artpgr01p", "item": "CPU utilization", "color": "FFA726"},
        ...
        graph_widget(
            ...
            [
                ...
                {"host": "artpgr01p", "item": "Memory utilization", "color": "FFA726"},
        ...
        graph_widget(
            ...
            [
                ...
                {"host": "artpgr01p", "item": "Prometheus HTTP response time", "color": "FFA726"},
    ...
    siem_widgets = [
        item_widget(
            ...
            0,
            0,
            itemid("artgra01p", "net.tcp.service[http,,9000]"),
            "Graylog web/API",
            "ART32",
        ),
        item_widget(
            ...
            18,
            0,
            itemid("artgra01p", "net.tcp.service[tcp,,1514]"),
        ...
        item_widget(
            ...
            0,
            3,
            itemid("artgraidx01p", "net.tcp.service[http,,9200]"),
        ...
        item_widget(
            ...
            18,
            3,
            itemid("artgradb01p", "net.tcp.service[tcp,,27017]"),
        ...
        graph_widget(
            ...
            6,
            [
                {"host": "artgra01p", "item": "Graylog HTTP response time", "color": "42A5F5"},
                {"host": "artgraidx01p", "item": "OpenSearch HTTP response time", "color": "66BB6A"},
