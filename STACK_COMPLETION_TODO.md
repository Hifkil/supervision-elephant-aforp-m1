...
- [ ] Verifier apres reset que Nagios charge toujours les 17 hosts et 54 services sans erreur.
- [ ] Verifier que Prometheus voit toutes les targets attendues : HAProxy, Nginx, PostgreSQL, Blackbox, backup et Docker metrics.
- [ ] Prendre les captures necessaires pour le dossier ou la presentation : Zabbix dashboard, Nagios services, Grafana dashboard, Prometheus targets.
...
- [ ] Centralisation de logs avec Graylog, Rsyslog ou Splunk.
