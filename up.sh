...
print_access_row "Splunk dashboard" "http://localhost:8000/app/artemis/artemis_logs_dashboard" "admin / splunkadmin" "vue rapide des logs"
...
echo -e "  Splunk search     ${CYAN}index=artemis sourcetype=artemis:syslog${RESET}"
echo -e "  Log de test       ${CYAN}logger -n 127.0.0.1 -P 10514 -T \"test splunk\"${RESET}"
echo ""
